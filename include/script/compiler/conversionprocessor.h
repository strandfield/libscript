...
public:
  ...
  static std::shared_ptr<program::Expression> listinit(Engine *e, const std::shared_ptr<program::Expression> & arg, const Type & type, const std::shared_ptr<ListInitializationSequence> & linit);
